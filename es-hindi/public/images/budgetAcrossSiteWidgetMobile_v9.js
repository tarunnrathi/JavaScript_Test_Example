              ...
              const _highLightWidgetHtml =
                `<div class="home_strip">
                  <div class="home_strip_left">
                    ...
                    <a target="_blank" href="/budget/highlights/?hasLayout=false">HIGHLIGHTS</a>
                    </div><div class="home_strip_midd">
                    <div class="home_strip_slider">
                    <div class="glide__track" data-glide-el="track">
                    <div id="budgetWidgetScrossSite" class="glide__slides">` +
                _listItem +
                '</div></div></div></div><div class="home_strip_right"><a target="_blank" href="/budget/highlights/?hasLayout=false" class="detailedview">Detailed View</a></div></div>';
