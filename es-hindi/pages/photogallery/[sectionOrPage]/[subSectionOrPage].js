...
const PhotogalleryCategory = dynamic(() =>
  import("components/Desktop/PhotogalleryCategory")
);

//Mobile import
const MobileLayout = dynamic(() => import("layouts/Mobile/MobileLayout"));
const CategoryMobile = dynamic(() =>
  import("components/Mobile/PhotogalleryCategoryMobile")
);
...
export async function getServerSideProps(context) {
  return await photogalleryListProps(context);
}
