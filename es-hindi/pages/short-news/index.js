...
const shortNewsCategory = [
  {
    id: 1,
    url: "/short-news/entertainment/",
    title: "मनोरंजन",
    icon: "/images/impactShort/manoblack.svg",
  },
  {
    id: 2,
    url: "/short-news/cricket/",
    title: "क्रिकेट",
    icon: "/images/impactShort/cricket.svg",
  },
  {
    id: 3,
    url: "/short-news/business/",
    title: "मनी",
    icon: "/images/impactShort/money.svg",
  },
  {
    id: 4,
    url: "/short-news/lifestyle/",
    title: "लाइफ़",
    icon: "/images/impactShort/life.svg",
  },
  {
    id: 5,
    url: "/short-news/tech/",
    title: "मोबाइल टेक",
    icon: "/images/impactShort/tech.svg",
  },
  {
    id: 6,
    url: "/short-news/nation/",
    title: "देश",
    icon: "/images/impactShort/desh.svg",
  },
  {
    id: 7,
    url: "/short-news/crime/",
    title: "क्राइम",
    icon: "/images/impactShort/crime.svg",
  },
  {
    id: 8,
    url: "/short-news/knowledge/",
    title: "नॉलेज",
    icon: "/images/impactShort/knowledge.svg",
  },
  {
    id: 9,
    url: "/short-news/health/",
    title: "हेल्थ & फिटनेस",
    icon: "/images/impactShort/health.svg",
  },
  {
    id: 10,
    url: "/short-news/career/",
    title: "करियर",
    icon: "/images/impactShort/carrer.svg",
  },
  {
    id: 11,
    url: "/short-news/ajab-gajab/",
    title: "अजब गजब",
    icon: "/images/impactShort/agj.svg",
  },
  {
    id: 12,
    url: "/short-news/jobs/",
    title: "नौकरी",
    icon: "/images/impactShort/job.svg",
  },
  {
    id: 13,
    url: "/short-news/astro/",
    title: "राशि",
    icon: "/images/impactShort/israshi.svg",
  },
];
  ...
  return (
    <>
      ...
      <div className="nws_hdr">
        ...
        <div className="nws_menu">
          {pageData.isMobile ? (
              ...
              <div className="newhdrlnghover">
                <ul>
                  {shortNewsCategory.map((itm, index) => (
                    <li key={`it-${itm.id}`}>
                      <a href={itm.url}>
                        <span>{/* <img src={itm.icon}></img> */}</span>
                        {itm.title}
                      </a>
                    </li>
                  ))}
            ...
            <ul>
              {shortNewsCategory.slice(0, 9).map((itm) => (
                <li key={itm.id}>
                  <a href={itm.url}>
                    <span>
                      <img alt="icons" src={itm.icon} />
                    </span>
                    {itm.title}
                  </a>
                </li>
              ...
              <li>
                <div className="newchoosecitywrap">
                  <a className="newchoosecitybtn">More</a>
                  <div className="newhdrlnghover">
                    <ul>
                      {shortNewsCategory.slice(9, 13).map((itm) => (
                        <li className="" key={itm.id}>
                          <a href={itm.url}>
                            <span>
                              <img alt={itm.title} src={itm.icon}></img>
                            </span>
                            {itm.title}
                          </a>
                        </li>
      ...
      <style jsx global>{`
        ...
        .newchoosecitywrap .newiconsprite.newarrow {
