...
const LatestNewsProps = async (context) => {
  ...
  const paramObj = {
    pageUrl: "/pro-kabaddi-league/pkl-news/",
  ...
  let [
    ...
    getArticleList({
      count: 50,
      filter: { "tags.slug": "pro-kabaddi-league" },
      fields: "display_headline,weburl_r,headline,images",
    }),
    getArticleList({
      count: 5,
  ...
  pageSeo.breadCrumbArray = [
    ...
    { value: "pkl news", slug: currentUrl }
   ];
  const pageData = {
    isMobile,
    currentUrl,
    ...
    top_headlines,
    latestNews,
    dataLength: latestNews.length || 0,
    photoGallery,
    seoData: pageSeo,
  };
