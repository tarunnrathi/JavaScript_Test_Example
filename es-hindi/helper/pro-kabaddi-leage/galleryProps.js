...
const GalleryProps = async (context) => {
  ...
  let [
    ...
    getArticleList({
      ...
      fields: "display_headline,weburl_r,headline,images,updated_at",
    }),
  ]);
  ...
  const pageSeo = {
    ...
    og_image:
      SITE_CONfIG.PRO_KABADDI_OG_IMAGE,
  };
  ...
  pageSeo.breadCrumbArray = [
    ...
    { value: "pkl gallery", slug: currentUrl },
   ];
  const pageData = {
    isMobile,
    currentUrl,
