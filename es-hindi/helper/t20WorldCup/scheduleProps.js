...
const scheduleProps = async (context) => {
  ...
  let [
    ...
    getCricketData(`schedule/series/${t20_world_cup_series_id}`, `schedule_series_${t20_world_cup_series_id}`),
  ...
  const pageSeo = {
    title: `ICC T20 World Cup ${t20_world_cup_year} Schedule: Check T20 WC ${t20_world_cup_year} India Team Cricket Schedule, Matches, Fixtures, Date And Timings`,
    keywords: `ICC T20 World Cup ${t20_world_cup_year}, ICC T20 World Cup ${t20_world_cup_year} Schedule, T20 World Cup Match Dates, T20 World Cup ${t20_world_cup_year} Venues, T20 World Cup ${t20_world_cup_year} Fixtures, T20 World Cup Schedule ${t20_world_cup_year} Time Table,T20 World Cup ${t20_world_cup_year} Match,T20 World Cup ${t20_world_cup_year} Schedule`,
    description: `ICCWorld Cup ${t20_world_cup_year} Schedule: Get complete T20 World Cup schedule, fixtures, dates and time, venue of all the ICC Men’s T20 World Cup ${t20_world_cup_year} matches at News18.com.`,
  ...
  pageSeo.jsonLdForWebPage = jsonLdForWebPage(
    ...
    `${host}/cricket/icc-t20-world-cup/schedule/`,
    null,
    true,
    false,
    true
