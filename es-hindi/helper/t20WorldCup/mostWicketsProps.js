...
import { getRedisDataByMultiKey, getMenu, getRedisDataByKey, getArticleList, getGoogleConfig, getCricketData, getCricketDataDirect, RhsphotoStories, RhstopStories } from "api_dns/global/Common";
...
const mostWicketsProps = async (context) => {
  ...
  const pageSeo = {
    title: `ICC T20 World Cup ${t20_world_cup_year} Wickets: Most Wickets Taken by Bowlers, Top Wicket Takers Latest News Update - Hindi News18`,
    keywords: `ICC Men's T20 World Cup ${t20_world_cup_year}, Most Wickets in T20 World Cup ${t20_world_cup_year}, ICC T20 World Cup ${t20_world_cup_year} Most Wickets, T20 World Cup ${t20_world_cup_year} Most Wickets, Best Bowling in T20 World Cup ${t20_world_cup_year}`,
    description: `Get ICC T20 World Cup ${t20_world_cup_year} top wicket-takers bowler in ICC Cricket T20 World Cup ${t20_world_cup_year}. Stay updated with the latest cricket statistics and records in Hindi`,
  ...
  pageSeo.jsonLdForWebPage = jsonLdForWebPage(
    ...
    `${host}/cricket/icc-t20-world-cup/most-wickets/`,
    null,
    true,
    false,
    true
