...
import { T20WcPhotoAds as homeAds } from "includes/Desktop/dfpAdIds";
import { T20WcPhoto as homeMobileAds } from "includes/Mobile/dfpAdIdsMobile";
import { checkDevice, getSetTargettingValues } from "includes/helper";
import { arrayOnly } from "includes/article.util";
import { TaboolaList } from "includes/Tabola.helper";
import { getRedisDataByMultiKey, getMenu, getRedisDataByKey, getArticleList, getGoogleConfig, getCricketData,getCricketDataDirect ,RhstopStories } from "api_dns/global/Common";
...
const photosProps = async (context) => {
  ...
  let [
    ...
    getArticleList({ count: 20, filter: { post_type:"photogallery",'tags.slug':`icc-t20-world-cup`}, fields: 'display_headline,weburl_r,images,weburl' }),
    getMenu(isMobile),
    getGoogleConfig(),
    // getDistricts(),
  ...
  const pageSeo = {
    title:`ICC T20 world Cup ${t20_world_cup_year} Photos, News, Images, Pictures on News18 Hindi `,
    keywords:`T20 World Cup ${t20_world_cup_year} Photos, ICC T20 Photos, Photos ICC T20 World Cup ${t20_world_cup_year}, ICC T20 World Cup ${t20_world_cup_year} Pictures, आईसीसी T20 वर्ल्ड कप ${t20_world_cup_year} फ़ोटो, T20 World Cup ${t20_world_cup_year} Images, T20 World Cup ${t20_world_cup_year} Pictures`,
    description:`ICC T20 World Cup ${t20_world_cup_year} Photos (टी20 विश्व कप ${t20_world_cup_year} फोटोज़) : Get best Images for ICC Cricket T20 World Cup Series Picture during live match`,
  ...
  pageSeo.jsonLdForWebPage = jsonLdForWebPage(
    ...
    `${host}/cricket/icc-t20-world-cup/photos/`,
    null,
    true,
    false,
    true
