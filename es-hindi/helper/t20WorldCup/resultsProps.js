...
const resultsProps = async (context) => {
  ...
  let [
    ...
    getCricketData(`series-result/${t20_world_cup_series_id}`, `series-result_${t20_world_cup_series_id}`),
  ...
  const pageSeo = {
    title:`ICC T20 World Cup ${t20_world_cup_year} Results: T20 WC Live Score, Today Match Results `,
    keywords:`ICC T20 World Cup ${t20_world_cup_year}, ICC T20 World Cup ${t20_world_cup_year} Results, T20 World Cup Match Dates and Time, T20 World Cup ${t20_world_cup_year} Results, T20 World Cup ${t20_world_cup_year} qualifying results`,
    description:`ICC Men’s World Cup ${t20_world_cup_year} Results: Get complete Results of all the ICC Men’s T20 World Cup ${t20_world_cup_year} matches and more at News18.com`,
  ...
  pageSeo.jsonLdForWebPage = jsonLdForWebPage(
    ...
    `${host}/cricket/icc-t20-world-cup/results/`,
    null,
    true,
    false,
    true
