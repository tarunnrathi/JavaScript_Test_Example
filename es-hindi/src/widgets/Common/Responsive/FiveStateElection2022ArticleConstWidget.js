...
const FiveStateElection2022ArticleConstWidget = (props) => {
  const fs_statename = props.data[0];
  const fs_cons_id = props.data[1];
  useEffect(() => {
  ...
  async function fiveStateInArticleWidget() {
    const mobileWidgetUrl =
      ...
      "assembly/elections/" +
      fs_statename +
      "/get-mobile-const-status/" +
      fs_cons_id.toLowerCase() +
      "/";
    fetch(mobileWidgetUrl)
      .then((res) => res.json())
      .then((response) => {
  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        .ls-main-head .ls_res_head_con2 ul li {
          list-style-type: none !important;
          width: auto;
          line-height: 22px;
        }
        .ls-main-head .ls_res_head_con2 {
          width: 100px;
        }
        .ls-main-head .heading.mt30 {
          width: 80%;
        }
        .ls-main-head .ls_res_head_con2 ul {
          border: 0;
        }
        .ls_result_table .elre_row.icons_bg li {
          width: 48% !important;
          line-height: 18px;
        }
        #ele-const-widget .ls_res_head_con2 li {
          list-style: none;
          padding-top: 10px;
        }
        .election_reultwrap1.tabresult2 .elre_row.icons_bg ul {
          justify-content: flex-start;
        }
        .election_reultwrap1.tabresult2 .elre_row.icons_bg ul li {
          width: 100% !important;
          text-align: left;
        ...
        .election_reultwrap1.tabresult2 .elre_row.icons_bg ul li:last-child {
          padding: 0;
        }
      `}</style>
    </>
