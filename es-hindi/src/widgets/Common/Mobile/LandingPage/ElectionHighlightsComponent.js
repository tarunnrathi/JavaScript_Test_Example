...
const ElectionHighlights = ({ highlightsData, elecSponserData }) => {
  ...
  try {
    return (
      highlightsData === undefined || highlightsData === null || highlightsData === [] || highlightsData === {} ?
        null
      :
      <>
        {/*  <!-- highlight start -->	 */}
        <div className="elec-glblhd-highlight under_border" id="electionHighlights">
          <div>
            <a href={`/assembly-elections/highlights${mainUrlParam}`} target="_blank"><h2>बड़ी<span>बातें</span></h2></a>
          </div>
        ...
        <div className="stel-hglgt">
          ...
          <div className="stel-hglgt-shr">
            ...
            <ul>
              <li>
                <a href={`https://www.facebook.com/sharer.php?u=${highlightsData[0].url || ""}&t=${highlightsData[0].display_name || ""}`} className="elecsprite fb" target="_blank"></a>
              </li>
              <li>
                <a href={`https://twitter.com/share?text=${ highlightsData[0].display_name || ""}&url=${highlightsData[0].url || ""}`} className="elecsprite tw" target="_blank"></a>
              </li>
              <li>
                <a href={`https://web.whatsapp.com/send?text=${highlightsData[0].display_name || ""}${highlightsData[0].url || ""}`} className="elecsprite whatsapp" target="_blank"></a>
              </li>
            </ul>
          </div>
        </div>
