...
const NewsListingMobile = (props) => {
  const {
    data: {
      pageAds,
      currentUrl,
      sliderFlag,
      _pageParam: { category = "", subCategory = "", get_section = {} } = {},
    } = {},
  } = props;
  ...
  const bftAdPosition =
    props.categoryStoriesList.length >= 13
      ? 13
      : props.categoryStoriesList.length;
...
export default NewsListingMobile;
