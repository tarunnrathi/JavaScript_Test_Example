...
import StateDistrictSelect from "./districtWidget/StateDistrictSelect";
import StatesSlider from "./districtWidget/StatesSlider";
...
const News18LocalPage = (props) => {
    ...
    return(<>
        <div className="top_banr"><span className="lg_ani">
            <h1><img src="/images/districts/LOCAL18logo.png" width="217px" height="80px" alt="Local18"/></h1>
            <img className="img2" src="/images/logos/News18-Logo-black.svg" width="217px" height="80px" alt="News18" /></span>

            <p className="sub_ttl"><strong>NEWS18 LOCAL</strong> RELIABLE AND ACCURATE NEWS FROM YOUR DISTRICT</p>
        </div>
        <div className="newcontainer clearfix">
            <StatesSlider />
            <StateDistrictSelect />
            <TopNewsState topPriorityData={topPriorityData || []} />
        </div>
	    <div className="newcontainer clearfix">
        ...
        <style jsx global>{`
                ...
                .top_banr .sub_ttl{font-size: 15px;line-height: 19px; letter-spacing: 3px;text-transform: uppercase;width: 100%; margin: 15px auto;}
                .top_banr p{letter-spacing: 0px;font-size: 14px;line-height: 20px; color: #101010; max-width: 70%; margin: 0 auto;}
