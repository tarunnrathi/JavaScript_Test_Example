...
const bestOfLocal18Widget = ({ data, aurPadheLink }) => {
    ...
    <div className="lcheading">
			...
			<div className="bofloc">
				...
				<div className="bolfcbtn"><a href={"/agency/local18/"} className="moretrndstroy">और भी पढ़ें</a></div>
			</div>
			<style jsx>{`	.bofloc{display: flex; justify-content: space-between; margin-top: 10px;flex-wrap: wrap;} 
				.bofloc ul{flex-shrink: 0;}
				.bofloc ul li{border-bottom: 1px solid #e0e0e0;padding: 12px 0; position: relative;}
				.bofloc ul li a{display: flex;}
				.bofloc ul li a figure{width: 80px; height: 54px; margin-right: 12px;box-shadow: 0px 2px 4px #0000001a;}
				.bofloc ul li a figure img{width: 80px; height: 54px;}
				.bofloc ul a span{color: #000;line-height: 22px; font-weight: 600;font-size: 15px; display: -webkit-box;   -webkit-line-clamp: 2;  -webkit-box-orient: vertical;  overflow: hidden; max-height: 42px;}
				.bofloc ul:first-child{width: 100%;}
				.bofloc ul li:first-child{padding-top: 0}
				.bofloc ul:first-child li a{display: block;}
				.bofloc ul:first-child li a figure{box-shadow: none;margin-bottom: 5px; border-radius: 4px;}
				.bofloc ul:first-child li a figure, .bofloc ul:first-child li a figure img{width: 100%;height: 100%;}
				.bofloc ul:first-child li a span{color: #000; font-weight: 600;line-height: 26px;font-size: 18px; display: -webkit-box;   -webkit-line-clamp: 3; -webkit-box-orient: vertical; overflow: hidden;max-height: 52px;}
				.bofloc ul:first-child li a p{color: #5F5F5F;line-height: 21px;font-size: 14px; display: -webkit-box;  -webkit-line-clamp: 2; -webkit-box-orient: vertical;overflow: hidden;}
				.bofloc ul:nth-child(2){width: 100%;margin: 12px 0 5px;}
				.bolfcbtn {background: #F6F7F7; width: 100%;padding-top: 5px;}
			`}</style>
    </>)
};
