   ...
   */
   ...
   return (
      <>
            ...
            <div className="row container jus_center section-blog clearfix">
               <div className="bns_left leftwrap section-blog-left ">
                  ...
                  <div className="bitbns-container">
                     <span className="heading"><em>{getStockName}</em><a onClick="ga('send', 'event', 'trade_now', 'Click', 'Bitbns')" href="https://bitbns.com/trade/#/login/" target="_blank" className="tradenow_btn" >Trade Now</a></span>
                        ...
                        {news.map((item, i) => (
                           <ul className={q != '' ? "show" : "hide"}>
                              {Object.keys(item).filter((i) => i.includes(q)).map((data, index) => (<>
                                 ...
                                 {/* <li onClick={() => {handleChange()}} >{data}</li> */}
                              </>))}
                           </ul>))}
                     </div>
               ...
               <RhsCommon
                  isbitbns={props.topPriorityData?.isbitbns || false}
         ...
         <style jsx global>
            {`.brdacrum{font-size:14px;color:#404040;line-height:18px;font-weight:700;margin:5px 0 15px 0}.brdacrum h1{display:inline-block;font-size:14px;}.brdacrum a{color:#404040;font-weight:400;margin-right:2px}
         .show{
            display:block;
         }
         .hide{
