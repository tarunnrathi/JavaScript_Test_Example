    ...
    return (
        <>
                ...
                <ul>
                    {
                        dataList.first && dataList.first.length === 1 && dataList.first.map((firstItem, index) =>
                            <li key={heading.replace(/ /g, '')+`first`+index}>
                                <a href={getCompleteURL(firstItem?.weburl_r, firstItem?.weburl)}>
                                    {
                                        firstItem?.images?.url && (
                                            <figure width={280} height={186}>
                                                <LazyLoadImage
                                                    src={firstItem?.images?.url}
                                                    width={280}
                                                    height={186}
                                                    alt={firstItem.display_headline}
                                                    title={firstItem.display_headline}
                                                />
                                            </figure>
                                        )
                                    }
                                    <h3>{firstItem.display_headline}</h3>
                                    <p>{firstItem.headline}</p>
                                </a>
                            </li>
                        )
                    }
            ...
            <style jsx global>{`
                ...
                .newsixstories ul li a figure{width: 104px; height: 70px; margin-right: 12px;box-shadow: 0px 2px 4px #0000001a; font-size: 0;}
                .newsixstories ul li a figure img{width: 104px; height: 70px !important; border-radius: 4px !important;}
                ...
                @media (max-width:768px){
                    ...
                    .newsixstories { display: block !important; margin-top: 0 !important; } .newsixstories ul:first-child { width: 100% !important; } .newsixstories ul li { padding: 12px 10px !important; position: relative; min-height: 90px;} .newsixstories ul:first-child li:first-child {padding-top: 0 !important;border-bottom: 1px solid#e0e0e0; padding-bottom: 6px !important;margin-top: 10px;} .newsixstories ul:first-child li a figure{width: 100% !important; height: 228px !important; float: none; margin-left: 0;} .newsixstories ul:first-child li a figure img{width: 100% !important; height: 228px !important;} .newsixstories ul:first-child li a h3{color: #000; line-height: 26px !important; font-size: 18px !important; margin-top: -8px; margin-bottom: 0;} .newsixstories ul:first-child li a p{display:none;} .newsixstories ul:nth-child(2) { width: 100% !important; padding: 0 !important; margin: 0 !important; } .newsixstories ul li a{display: block !important;} .newsixstories ul li a figure{float: right; display: inline-block; margin-left: 12px; margin-right: unset;} .newsixstories ul:last-child { width: 100% !important; } .newsixstories ul:last-child li:first-child{height: unset !important;} .newsixstories ul:last-child li a figure { width: 104px !important; height: 70px !important; margin-left: 12px !important; margin-bottom: 0 !important; } .newsixstories ul:last-child li a figure img { width: 104px !important; height: 70px !important; } .newsixstories ul:first-child li a figure{margin-right: unset;} .moretrndstroygrey { background: none !important; border: 0 !important; height: auto !important; }
