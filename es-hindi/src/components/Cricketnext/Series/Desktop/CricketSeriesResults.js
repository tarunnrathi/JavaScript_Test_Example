...
const CricketSeriesResults = ({ pageContent }) => {
  return (
    <>
          ...
          <div className="CN-result-row" key={series?._id}>
            ...
            {series?.match &&
              ...
              series?.match?.map((match) => {
                ...
                return (
                <div className="result-box" key={match?.matchfile}>
                  <div className="result-col-l">
                    ...
                    <div className="result-teamWrap">
                      <div className="rs-inner">
                        ...
                        <div className="vs">
                          <img src="https://images.news18.com/static_news18/pix/ibnhome/news18/images/cricket/result-vs.png" alt="" /></div>
                        <div className="result-teambox">
                          <div className="flag">
                            <span>
                              <ImageFallback
...
export default CricketSeriesResults;
