...
const cnNewsMobile = (props) => {
    ...
    const query_arr = { post_type: "photogallery", "subsection.id": "29" };
    ...
    return (
        <>
                        ...
                        <div className="CN-section">
                            <div className="CN-sec-l">
                                <div className="CN-heading-1">
                                    <h2 className="headinner">लेटेस्ट <span>फोटोगैलरी</span></h2>
                                    <div className="icon"></div>
                                </div>
                                <div className="CN-videowrap">
                                            ...
                                            categoryData && categoryData.length ? (
                                                categoryData.map((latest, index) => (
                                                    ...
                                                    <div className="CN-videosec-h">
                                                        <div className="heading"><a href={latest.weburl_r}>{latest.display_headline!='' ? latest.display_headline : latest.headline}</a></div>
                                                        <div className="image-box">
                                                            <a href={latest?.weburl_r}>
                                                                <span className="counter">{latest?.gallery_count || 0} photos</span>
                                                                <span className="overlay"></span>
                                                                <span className="img-icon">
                                                                    <img src="https://images.news18.com/static_news18/pix/ibnhome/news18/images/cricket/Photo-Icon.svg" alt={latest.display_headline!='' ? latest.display_headline : latest.headline} title={latest.display_headline!='' ? latest.display_headline : latest.headline} />
                                                                </span>
                                                                <LazyLoadImage width="100%" src={latest?.images?.url} alt={latest.display_headline!='' ? latest.display_headline : latest.headline} title={latest.display_headline!='' ? latest.display_headline : latest.headline} />
                                                            </a>
                                                        </div>
                                                    </div>
                                                    </>
                                ...
                                {/* <Pagination  curpage={props.data.pageNumber} TotalRecord={dataLength} limit={props.data.pageLimit} pageurl={props.data.PhotoUrl} pageflag={false} /> */}
                                <p className="pageContent">क्रिकेट (Cricket) दुनिया के सबसे लोकप्रिय खेलों में से एक है. इस खेल के मैच तकरीबन हर घंटे खेले जाते हैं. इस खेल की खबरें लगातार आती रहती हैं. मैचों का टेलीविजन और ऑनलाइन लाइव प्रसारण भी होता है. खेल और खिलाड़ियों की तस्वीरें भी खूब पसंद की जाती हैं. सोशल मीडिया पर भी ऐसी तस्वीरें खूब वायरल होती हैं. खेल और खिलाड़ियों से संबंधित तस्वीरों (Photos) को यहां देखा जा सकता है.</p>
                                <Taboola
            ...
            <style jsx global>{`
                ...
                .CN-videowrap {background: #222222;padding: 10px 0 0 0;margin-bottom: 10px;font-family: 'Mukta',sans-serif !important;}
                .CN-videosec-h {position: relative;width: 100%;box-sizing: border-box;padding: 10px 10px 0;margin-bottom:30px;}
                .CN-videosec-h:last-child {margin-bottom:0;}
                .CN-videosec-h::before {content: '';position: absolute;width: 40px;background: #e1261c;height: 6px;top: 0;left: 0;}
                .CN-videosec-h .heading {margin-bottom: 5px;}
                .CN-videosec-h .heading a {display: block;font-size: 16px;line-height: 22px;color: #fff;}
                .CN-videosec-h .image-box {position: relative;}
                .CN-videosec-h .image-box a, .image-box a img {display: block;width:100%;}
                .CN-videosec-h .image-box a {border-radius:5px;overflow: hidden;border: 1px solid #707070;}
                .CN-videosec-h .image-box .counter {position: absolute;right: 0;background: #E1261D;color: #fff;font-size: 12px;padding: 1px 6px;top: 10px; z-index:1}
                .CN-videosec-h .image-box .img-icon {position: absolute;left: 50%;top: 50%;transform: translate(-50%, -50%);}
                .CN-heading-1 {font-family: 'Fira Sans', sans-serif;font-weight: 700;text-transform: uppercase;font-size: 18px;color: #E1261C;padding: 0 0 0 10px; margin-bottom: 10px;display: flex;justify-content: space-between;align-items: center;background: url(https://images.news18.com/static_news18/pix/ibnhome/news18/images/cricket/cn-heading-bg-2.png);background-repeat: repeat-x;background-position: center;    position: relative;}
                .CN-heading-1:after {content: '';position: absolute;background:#222;width: 22px;height: 19px;right: 0;}
                .CN-heading-1 .headinner span{color:#001D42;}
                .CN-heading-1 .icon {border: solid #ffffff;border-width: 0 2px 2px 0;display: inline-block;width: 8px;height: 8px;transform: rotate(-45deg);-webkit-transform: rotate(-45deg);margin-right: 10px;z-index:1;}
                .series-banner img{display: block;width: 100%;}
