                                            ...
                                            categoryData.map((latest, index) => (
                                                <li key={`map_${index}`}>
                                                    ...
                                                    <div className="image-box">
                                                        <span><img height="30" width="30" src="https://images.news18.com/static_news18/pix/ibnhome/news18/images/cricket/Photo-Icon.svg" alt="" title="" /></span>
                                                        <LazyLoadImage height="144" width="217" src={latest?.images?.url} alt={latest?.display_headline} title={latest?.display_headline} />
                                                    </div>
