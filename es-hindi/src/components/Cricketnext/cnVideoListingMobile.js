                                                        ...
                                                        <div className="image-box">
                                                            <a href={latest?.weburl_r}>
                                                                ...
                                                                <span className="img-icon">
                                                                    <img src="https://images.news18.com/static_news18/pix/ibnhome/news18/images/cricket/play-icon1.svg" alt={latest.display_headline!='' ? latest.display_headline : latest.headline} title={latest.display_headline!='' ? latest.display_headline : latest.headline} />
                                                                </span>
                                                                <LazyLoadImage height="227" width="340" src={latest?.images?.url} alt={latest.display_headline!='' ? latest.display_headline : latest.headline} title={latest.display_headline!='' ? latest.display_headline : latest.headline} />
                                                            </a>
                                                        </div>
                                                    </div>
                                                    </>
