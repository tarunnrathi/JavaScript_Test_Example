...
const CricketHeaderNewMobile = ({ current = 0, isIpl, crMenu = [], isT20, pageType }) => {
    const [ranking, setRanking] = useState(false);
    const [teams, setTeams] = useState(false);
    return (
        <>
          <div className="CNL1MenuNew">
            <ul className="nav-box">
                ...
                <li className="cn-dropdown " id="rankingBtn" onClick={() => {
                  setRanking(!ranking);
                  setTeams(false);
                }}>
                    <a>
                    ...
                    <div id="rankingMenu" className="drop-inner" style={{ display: ranking ? "block" : "none" }}>
                ...
                <li className={`cn-dropdown ${current == 9 && !isIpl ? "current" : ""}`} onClick={() => {
                  setTeams(!teams);
                  setRanking(false);
                }}>
                    <a>टीमें</a>
                    <div id="teamsMenu" className="drop-inner" style={{ display: teams ? "block" : "none" }}>
                      <div className="dropdown-sec">
            ...
            .CNL1MenuNew{ display: flex;
              ...
              .drop-inner .dropdown-sec:last-child {
                border: 0;
              }
              .drop-inner .dropdown-sec li:hover a {
                border: 1px solid #d8d8d8;
                background: #f5f5f5;
                color: #e1261d;
              }
              .drop-inner .dropdown-sec li {
                padding-left: 2px;
                box-shadow: none;
              }
              .drop-inner .dropdown-sec .droplist-2 > li > a {
                display: block;
                padding: 6px 7px;
              }
...
export default CricketHeaderNewMobile;
