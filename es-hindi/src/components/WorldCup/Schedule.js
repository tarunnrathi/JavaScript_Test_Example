...
const MatchScheduleList = dynamic(() =>
  import("components/Cricket/Desktop/WorldCup/MatchScheduleList"),
);

const MatchScheduleListMobile = dynamic(() =>
  import("components/Cricket/Mobile/WorldCup/MatchScheduleListMobile"),
);
            ...
            <BreadcrumbCommon breadCrumbArray={[
              ...
              <div className="CN-innersection">
                  ...
                  <div>
                    {pageContent && pageContent?.match?.length > 0 ? (
                      !props.isMobile ? (
                        ...
                        <MatchScheduleListMobile pageContent={pageContent} />
                      )
                    ) : (
                ...
                <p className="pageContent">
                  वनडे मैच आज क्रिकेट का सबसे पसंदीदा फॉर्मेट बनकर उभरा है.
                  इंटरनेशनल मैचों से लेकर लीग क्रिकेट तक हर रोज कहीं ना कहीं
                  इसके मैच हो रहे होते हैं. और अब तो वर्ल्ड कप (World Cup 2023)
                  भी बस शुरू होने को है. अगले महीने शुरू होने जा रहे इस
                  टूर्नामेंट की जानकारी हर क्रिकेट फैन को चाहिए होती है. न्यूज18
                  हिंदी आपके लिए वर्ल्ड कप का पूरा शेड्यूल (Schedule) लेकर आया
                  है. इसकी जानकारी यहां से मिल सकती है. मैचों की टाइमिंग भारतीय
                  समय के मुताबिक दी गई है.
                </p>
              </div>
            </div>
