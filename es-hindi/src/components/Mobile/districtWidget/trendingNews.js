...
const TrendingNews = ({ data, aurPadheLink }) => {
    ...
    const second = dataList.slice(1, 6);
    return (<>
    <div className="trendnw_wrap">
        <div className="lcheading">
                    ...
                    {!isLoading ? <><div className="trendstry">
                ...
                <style jsx>{`
                .newbuttonlist{display: flex; align-items: center; overflow: scroll; height:40px;} 
                ...
                .trnw_tp li a section{color: #000;line-height: 26px; font-weight:600;font-size: 18px; font-weight: bold; margin-bottom: 4px;}
                ...
                .trnw_btm a section{color: #000;line-height: 26px;font-weight:600;font-size: 16px;display: -webkit-box; -webkit-line-clamp: 2;-webkit-box-orient: vertical; overflow: hidden;}
                .trnw_btm li:first-child{padding-top: 0}
                .trnw_btm li a figcaption{position: relative; width: calc(100% - 80px);}
