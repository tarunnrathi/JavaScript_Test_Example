...
const StateStoriesWidget = ({ stateStories = [], aurPadheLink = "" }) => {
    ...
    const first = stateStories.slice(0, 1);
    const second = stateStories.slice(1, 11);
    return (
    <>
    <div className="niyl_wrap rkkbr">				
        ...
        .newbuttonlist a{color: #524F4F;font-size: 12px; line-height: 24px; display: block; text-align: center; padding: 3px 12px; margin: auto 10px; height: 30px; background-color: #FFFFFF; border: 1px solid #E0E0E0; border-radius: 15px; flex-shrink: 0;}
        .newbuttonlist.gry a { background-color: #F2F2F2;}
        .newbuttonlist a.active, .newbuttonlist.gry a.active{color: #fff;background-color: #E1261C; box-shadow: 0px 3px 6px #00000029;  border: 1px solid #FFFFFF; border-radius: 15px;padding: 4px 12px;}
        .newbuttonlist a:last-child{margin-right: 0;}
        
        .niyl_wrap {background-color: #F4F4F4; padding: 8px 0 20px 0; border-top: 1px solid #C7C7C7;   border-bottom: 1px solid #C7C7C7;}
        .rkkbr{background-color: #fff;border-bottom: 0;}
        .niylstory { padding: 0 10px;}
        figure { overflow: inherit;}
        .niy_tp{width: 100%;margin: 10px 0 15px; border-bottom: 1px solid #C7C7C7; padding: 0 0 6px 0;}
        .niy_tp li{padding-bottom: 3px;}
        .niy_tp li a{display: block;}
        .niy_tp li a figure, .niylstory .niy_tp li a figure img{width: 100%; height: 187px;margin-right: 0; margin-bottom: 5px; box-shadow: 0px 3px 6px #00000033;}
        .niy_tp li a section{color: #000;line-height: 30px;font-weight:600; font-size: 20px; font-weight: bold;}
        .niy_tp li a p{color: #5F5F5F;line-height: 26px; font-size: 16px; display: -webkit-box;    -webkit-line-clamp: 3; -webkit-box-orient: vertical; overflow: hidden;}
        .niy_tp li a figure img.phvid{position: absolute; top: 0;left: 0; right: 0; bottom: 0;margin: 0 auto;width: 35px;}
        .niy_tp li a figure img.phvid.ph {width: 28px;}
        
        .niy_btm{flex-shrink: 0;}
        .niy_btm li{border-bottom: 1px solid #C7C7C7;padding: 13.5px 0; position: relative;}
        .niy_btm li a{display: flex;}
        .niy_btm li a figure{width: 80px; height: 53px; margin-left: 12px;box-shadow: 0px 2px 4px #0000003b; }
        .niy_btm li a figure img{width: 80px; height: 53px;}
        .niy_btm a section{color: #000;line-height: 22px;font-size: 15px;font-weight:600;display: -webkit-box; -webkit-line-clamp: 2;-webkit-box-orient: vertical; overflow: hidden; padding-right: 15px;}
        .niy_btm li:first-child{padding-top: 0}
        .niy_btm li a figcaption{position: relative; width: calc(100% - 80px);}
        .niy_btm a svg{position: absolute; right: 0; top: 7%;}
