...
const RhsPhoto = memo(
  dynamic(() => import("widgets/Common/Responsive/RhsPhoto"))
);
const RhsTopStory = memo(
  dynamic(() => import("widgets/Common/Responsive/RhsTopStory"))
);
...
const RssMobile = (props = {}) => {
  const { photoStories = [], topStories = [] } = props.data || {};
  return (
    <>
      <div className="outer">
        <div className="">
