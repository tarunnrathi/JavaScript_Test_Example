...
const PodcastDetails = (props) => {
  ...
  const { isAjax = false, topPriorityData, pageAds } = props;
  ...
  const { categoryData, categoryDetailsData, breadCrumbArray } = topPriorityData;
  ...
  let headline = pageData?.display_headline || pageData?.title;
  ...
  return (
    <>
      <div className="clearfix">
        <div className="clearfix add"></div>
        <div className="podcast_page">
          <div className="podcast_container">
            ...
            <div className="podcast-listing_wrapper">
              <div className="podcast-listing_left" id="podcast_div">
                <div
                  ref={ref}
                  className="podcast-consumption"
                  rel="https://hindi.news18.com/podcast/news-bulletin/anton-chekhov-story-girgit-podcast-by-pooja-prasad-neer-4262300.html"
                  galtitle="रूसी कथाकार आंतोन चेखव की कहानी 'गिरगिट'"
                  id="podcast_consumption_4262300"
                  data-podcast_id="4262300"
                  data-author="News18 Hindi"
                  data-ga7="hindi.news18.com| unassigned |News18 Hindi"
                >
                  <div className="title_andshare">
                    <div className="class_wrapper_title_andshare">
                      <div>
                        <h1 className="consumption_title">{headline}</h1>
                      </div>
                          ...
                          <li>
                            <a
                              ...
                              onClick={async () => {
                                ...
                                logEvent("ss_wapi","tap","podcast_page");                   
                              }} 
                            >
                              <svg
                                id=""
                  ...
                  <div className="podcast-consumption-img">
                    <div
                      dangerouslySetInnerHTML={{ __html: podcastEmbed }}
                    ></div>
                  </div>
                ...
                <div id="infinite-scroll-section">
                  {stories && stories.length ? (
                    <PodcastAjax
                      ...
                      comp={PodcastDetails}
                      cat={query ? query?.category : "jeevan-samvad"}
                      isMobile={false}
                      dtype="news"
                      isCricketNext={false}
                    />
      ...
      {/* <InstallAppIcon category={'APPdownload_Mweb_Podcast'} label={'Mobile Podcast'} /> */}
      {!isAjax && (
        <style jsx global>
          {`
          html,
