  ...
  return (
    <>
          ...
          <div className="aqiwidget kul">
            <div className="aqiwidgethd">
              ...
              >
                ...
                <img src="https://images.hindi.news18.com/ibnkhabar/uploads/assets/event/common/images/havelslogo_1681199405.png" />
              </a> */}
            </div>
            <ul className="aqiwidgetlist">
              {
                aqiData.slice(0, 6).map((eachData, index) => {
                  if (eachData?.cityName && eachData?.airComponents && eachData?.airComponents['1']?.sensorData) {
                    ...
                    return <li key={`aqilist-${Math.random()}`} className={`aqistatus${condition.toLowerCase()}`}>
                      <a href="https://www.aqi.in/dashboard/india" target="_blank" rel="noreferrer">
                        <span>
      ...
      <style global jsx>{`
        ...
        .aqiwidget{padding: 10px 20px; border-bottom: 1px solid #EBEBEB; font-family: Muli,Helvetica Neue,Helvetica,Arial,sans-serif;} 
        ...
        align-items: center;}
        .aqiwidgethd h2, aqiwidgethd h3{font-size: 38px;color: #e1261d;font-weight: 600;text-transform: uppercase; line-height: 18px;}
