          ...
          <div className="CN-section">
            <div className="CN-sec-l">
              <BreadcrumbCommon breadCrumbArray={[
                ...
                { value: `T20 World Cup सर्वाधिक रन` },
              ]} />
              <div className="CN-innersection">
                <div className="cn-heading-1">
                  <div className="headinner"><h1>T20 World Cup {t20_world_cup_year} : <span>Most Run</span></h1></div>
                  <div className="icon"></div>
                </div>
                {props?.data?.mostRunsData && props?.data?.mostRunsData?.leaderboard?.length > 0 ? (
                  <table className="most-ran-table orange-cap">
                    <tbody>
                      ...
                      {props?.data?.mostRunsData?.leaderboard?.map((item, index) => (
                        <tr key={index}>
                          <td>{index + 1}</td>
                          <td>
                            <a href={item?.url}>
                ...
                <p className="pageContent">
                  टी20 वर्ल्ड कप {t20_world_cup_year} में सबसे ज्यादा रन बनाने वाले बल्लेबाजों
                  (Highest runs) की सूची यहां मिलेगी. हर दिन तकरीबन 3 मैच होंगे.
                  यानी एक दिन में 66 खिलाड़ी मैदान पर उतरेंगे. इन खिलाड़ियों का
                  उद्देश्य अपनी टीम को जीत दिलाना होगा. जीत हर किसी की चाहत हो
                  सकती है, लेकिन यह उसी टीम को मिलती है, जिसके खिलाड़ी बेहतर
                  प्रदर्शन करें. हम सब जानते हैं कि क्रिकेट में जीत-हार का
                  पैमाना मुख्य रूप से रन या विकेट से तय होता है. ज्यादा रन बनाने
                  वाली टीमें ही मैच जीतती हैं. ऐसे में उन बल्लेबाजों का महत्व
                  बढ़ जाता है, जो फॉर्म में हैं. यहां से बल्लेबाजों के अच्छे
                  प्रदर्शन का अंदाजा लगाया जा सकेगा.
                </p>
              </div>
            </div>
