...
const MatchScheduleList = dynamic(() => import("components/Cricket/Mobile/IPL/MatchScheduleList"));
...
const MatchSchedule = (props) => {
  ...
  const { pageTypeHin, seriesDisplayName } = paramObj;
  return (
    <>
      <Head>
        <link
      ...
      <div className="CN-pageOutter CN-Mobile-HomeOuter">
        <div className="CN-pageWrapper">
          ...
          <div className="CN-heading-1">
            <div className="headinner">सीरीज शेड्यूल : <h1>{seriesDisplayName}</h1></div>
