const IplTopStories = ({ IPLData }) => {

    const firstArray = IPLData.slice(0, 1);
    const secondArray = IPLData.slice(1, 3);
    const lastArray = IPLData.slice(3, 6);
        ...
        <>
            <div className="CN-Sections">
                <div className="CN-storyWrap">
                    ...
                    <a href="/cricket/ipl/news/" className="iplmorebtn"><span>और खबरें</span></a>
                </div>
            </div>
