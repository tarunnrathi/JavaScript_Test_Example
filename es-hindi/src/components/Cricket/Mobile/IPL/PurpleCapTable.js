import { displayAds, IPL_YEAR, PURPLE_CAP_HEADER } from "includes/ipl.helper";
...
const PurpleCapTableMobile = ({ data }) => {
  const { tableData=[], seoData, pageAds, ImageIdsAvailable } = data;
  const headerArr = PURPLE_CAP_HEADER;
  return (
    <>
        ...
        <BreadcrumbCommon breadCrumbArray={[
                  ...
                  { value: `पर्पल कैप ${IPL_YEAR}`},
                ]}
                isCapitalize={true}/>
        <div className="sponsor-with-heading">
            <h1 className="ipl-globahd">पर्पल कैप {IPL_YEAR}</h1>
...
export default PurpleCapTableMobile;