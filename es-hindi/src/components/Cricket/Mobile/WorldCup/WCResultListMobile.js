          ...
          matchList.map((match, index) => (
            <div className="result__match--wrapper" key={index}>
              <div className="result__match--info">
                <h3 className="result__match--heading">
                  {match?.teama} <span>vs</span> {match?.teamb},{" "}
                  {match?.matchno}
                </h3>
                <ul className="cn-rsltCont">
                  <li>
                    • {match?.matchDetail?.matchdate} • {match?.matchTime}
                  </li>
                  <li>• {match?.venue} </li>
              ...
              <div className="result__team--details">
                ...
                <div className="vs">
                  <img src={CricketNextImgUrls.vsRedImgUrl} alt="vs image" />
                </div>
                <div className="payer-thumb">
                  <h3 className="teamName">
                    <a>{match?.teamb}</a>
              ...
              <ul className="result__box--links">
                ...
                <li>
                  <a
                    href={`/cricket/live-score/team-squads/world-cup-${match?.matchfile}.html`}
                  >
                    स्क्वॉड
                  </a>
                </li>
