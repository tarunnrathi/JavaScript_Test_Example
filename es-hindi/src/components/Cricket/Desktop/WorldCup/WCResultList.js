...
const WCResultList = ({ pageContent }) => {
            ...
            <div className="result-box" key={index}>
              <div className="result-col-l">
                <div className="result-col-lWrap">
                  ...
                  <p className="cn-rsltCont">
                    {match?.matchDetail?.matchdate} • {match?.venue}
                  </p>
                </div>
                <div className="result-teamWrap">
                  <div className="rs-inner">
                    ...
                    <div className="vs">
                      <img
                        src={CricketNextImgUrls.vsRedImgUrl}
                        alt="vs image"
                      />
                    </div>
                    <div className="result-teambox">
                  ...
                  <div className="rs-matchresult">
                    मैच रिजल्ट्स: <span>{match?.matchDetail?.matchresult}</span>
                  </div>
                </div>
              </div>
              <div className="result-col-r">
                ...
                <ul className="result__box--links">
                  <li>
                    <a
                      href={`/cricket/live-score/world-cup-live-score-full-${match?.matchfile}.html`}
                    >
                      स्कोरकार्ड
                    </a>
                  </li>
                  <li>
                    <a
                      href={`/cricket/live-score/world-cup-ball-by-ball-live-commentary-${match?.matchfile}.html`}
                    >
                      मैच कॉमेंट्री
                    </a>
                  </li>
                  <li>
                    <a
                      href={`/cricket/live-score/team-squads/${match?.teama
                        ?.toLowerCase()
                        .replaceAll(" ", "-")}-vs-${match?.teamb
                        ?.toLowerCase()
                        .replaceAll(" ", "-")}-${match?.matchfile}.html`}
                    >
                      स्क्वॉड
                    </a>
                  </li>
