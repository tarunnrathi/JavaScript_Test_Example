      ...
      <style jsx global>
        {`
          ...
          @media (max-width:768px){
            .CN-schedule-row{display:block; margin-bottom:15px;}
            .schedule-box{flex-wrap: wrap; justify-content: center; border-left: 4px solid #e1261d;}
            .CN-schedule-row .schedule-box .schedule-col-r{border:0;padding-left:0;}
            .schedule-box .schedule-col-l .cn-rsltHead1{font-size: 16px;}
            .CN-schedule-row .CN-schedule-heading{    font-size: 18px;}
          }
        `}
      </style>
    </>
