...
const OrangeCapTable = ({ data, pageAds }) => {
  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        .forpurplecap:before {
          content: "";
          background: url(https://static.hindi.news18.com/ibnkhabar/uploads/assests/css/images/iplsprt.png) -5px -48px
            no-repeat;
          width: 44px;
          height: 41px;
          position: absolute;
