...
const IplVideoDesktop = ({ data }) => {
  ...
  const query_arr = { post_type:"videos",'tags.slug':`ipl-${IPL_YEAR}` };
  const {loadMore, categoryData, hasMoreData} = useLoadMore(videoPriorityData, pageLimit, dataLength, query_arr)
  return (
    <>
            ...
            <div className="container clearfix">
              ...
              <BreadcrumbCommon breadCrumbArray={[
                ...
                <div className="sponsor-with-heading">
                  <h1 className="ipl-globahd">IPL {IPL_YEAR} वीडियो</h1>
                          ...
                          <LazyImage
                            ...
                            onError={(event) => {
                              event.currentTarget.src =
                                "https://images.news18.com/ibnkhabar/uploads/assests/images/placeholder.jpg?impolicy=website&amp;width=521";
                            }}
                            width={220}
                            height={130}
                          />
...
export default IplVideoDesktop;