...
const PurpleCapTable = ({ data, pageAds }) => {
  ...
  return (
    <>
          ...
          <div className="iplwrapper">
            <div className="container clearfix">
              ...
              <BreadcrumbCommon breadCrumbArray={[
                ...
                isCapitalize={true}/>
                <h1 className="ipl_headin_g forpurplecap">
                  पर्पल कैप {IPL_YEAR}
                </h1>
                {tableData?.length > 0 &&
                <PurpleOrangeCapCommonTable
                  headers={headerArr}
                  backgroundColour={"#60398f"}
                  tableData={tableData}
                  columnKey={"wickets"}
      ...
      <style jsx global>{`
        ...
        .forpurplecap:before {
          content: "";
          background: url(https://static.hindi.news18.com/ibnkhabar/uploads/assests/css/images/iplsprt.png) -49px -48px
            no-repeat;
          width: 44px;
          height: 41px;
          position: absolute;
